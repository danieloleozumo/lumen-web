      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        ...
        <div className="lg:col-span-4 mb-2 lg:mb-0">
          ...
          <div className="flex gap-4">
            <a className="text-on-surface-variant hover:text-primary transition-colors cursor-pointer bg-surface-container w-10 h-10 rounded-full flex items-center justify-center" href="#" aria-label="Instagram">
            ...
            <a className="text-on-surface-variant hover:text-primary transition-colors cursor-pointer bg-surface-container w-10 h-10 rounded-full flex items-center justify-center" href="#" aria-label="Facebook">
        ...
        <div className="lg:col-span-4">
          ...
          <ul className="space-y-5 font-body-md text-body-md text-on-surface-variant">
            ...
            <li className="flex items-center gap-4">
              ...
              <a className="hover:text-primary transition-colors cursor-pointer" href="mailto:hola@lumensalud.com">hola@lumensalud.com</a>
            </li>
            <li className="flex items-center gap-4">
